...
int dfs_fewest_button_presses(struct Machine *machine, int button, int *joltage_levels, int total_joltage){
	...
	// TODO: dfs is a dead end, try something new
	// Ideas:	 
	// 	- equations?
	//		Input: (3) (1,3) (2) (2,3) (0,2) (0,1) {3,5,4,7}
	//		Equation: (3A+5B+4C+7D) = a(D) + b(B+D) + c(B) + d(C+D) + e(A+C) + f(A+B) 
	//		Solve for a,b,c,d,e and f => a = 1, b = 5, d = 1, e = 3 => 10
	//		Looks like it could work, but how do i program this?
